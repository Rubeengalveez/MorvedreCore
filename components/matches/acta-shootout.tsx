                  ...
                  {tanda.shots
                    ...
                    .map((shot) => (
                      <span
                        ...
                        className={`grid h-[22px] w-[22px] place-items-center rounded-full ${outcomeTone[shot.outcome]}`}
                      >
                        {shot.outcome === "goal" ? (
                        ...
                        <span className="sr-only">
                          #{shot.cap} · {shootoutOutcomeLabels[shot.outcome]}
                        </span>
                      </span>
                    ))}
                </div>
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="block truncate text-base font-extrabold">
                  {keeper ? `#${keeper.cap} · ${keeper.name}` : "Elige portero"}
                </span>
              </span>
              ...
              <div className="grid grid-cols-2 gap-2 border-t border-slate-200 bg-[#f4f8fb] p-3">
                {availableKeepers.map((player) => (
                  ...
                  >
                    ...
                    <span className="line-clamp-2 text-sm leading-tight">{player.name}</span>
                  </button>
                ))}
              </div>
            )}
          ...
          {state.winner || s.phase === "finished" ? (
            <section className="rounded-2xl bg-white p-4 text-center shadow-sm ring-1 ring-[#b8cada]">
              ...
              <button
                ...
                onClick={() => s.phase === "finished" ? onShare() : void change({ ...s, phase: "finished" })}
              >
                ...
                {cap === null ? (
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {candidates.map((player) => (
                        ...
                        >
                          ...
                          <span className="line-clamp-2 text-sm leading-tight font-extrabold">
                            {player.name}
                          </span>
                        </button>
                      ))}
                  ...
                  <>
                    ...
                    >
                      ...
                      <span className="line-clamp-1 min-w-0 font-extrabold">
                        {turnIsUs ? (selectedLauncher?.name ?? "Jugador") : "Gorro rival"}
                      </span>
                      <span className="ml-auto shrink-0 text-sm font-bold text-[#0b4d86]">Cambiar</span>
                    </button>
                    <div className="grid grid-cols-2 gap-3">
                      {!missed && (
                        <>
                          ...
                          <button
                            type="button"
                            className={`${styles.action} ${styles.actionShotMissed} !border-[#b91c1c] !bg-[#b91c1c] !text-white`}
                            disabled={!enabled}
                      ...
                      {missed && (
                        <>
                          <p role="status" className="col-span-2 text-base font-extrabold text-[#062048]">

...
export function Pagination({
  ...
  return (
    ...
    >
      <p className="text-[11px] font-semibold uppercase tracking-eyebrow text-ink-600">
            ...
            return (
              <li key={item}>
                <Link
                  ...
                  className={cn(
                    "inline-flex h-10 min-w-10 items-center justify-center rounded-md border px-2 text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pool-blue focus-visible:ring-offset-2 focus-visible:ring-offset-paper",
                    isActive

...
import { Shirt, Heart, Ticket, Bell, Mail, Sparkles, Check } from "lucide-react";
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-4 py-6">
      ...
      >
        ...
        {done ? (
          <div className="flex items-center gap-2 rounded-md border border-success/30 bg-success/10 p-3 text-sm font-semibold text-success">
            <Check className="h-4 w-4" />
            ¡Anotado! Te avisamos al abrir la tienda.
          </div>
        ) : (

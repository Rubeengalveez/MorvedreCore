  ...
  return (
    ...
    >
      <div className="relative">
        <WaterDivider fill="var(--brand-aqua)" height={48} />
        <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-3 px-6 pb-8 pt-8 text-center">
          ...
          />
          <h1 className="font-display text-3xl font-extrabold leading-tight text-brand-deep sm:text-4xl">
        ...
        <WaterDivider fill="var(--brand-foam)" height={32} variant="footer" />
      </div>
